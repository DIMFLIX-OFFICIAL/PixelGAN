...
class BusinessLunchGAN(VQAutoEncoder):
    def __init__(self, dim_embd=512, n_head=8, n_layers=9,
                 codebook_size=1024, latent_size=256,
                 connect_list=None, fix_modules=None, vqgan_path=None
                 ) -> None:
        super(BusinessLunchGAN, self).__init__(512, 64, [1, 2, 2, 4, 4, 8], 'nearest', 2, [16], codebook_size)
